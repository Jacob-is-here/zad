...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(s => s.DeptNo == 30).Min(s => s.Sal);
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps.OrderBy(s => s.HireDate).Take(2).ToList(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(s => s.Mgr is not null).ToList(); 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        var result = emps.All(s =>s.Sal > 500); 
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = emps.Any(s => s.Comm > 400); 
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(s => new {s.EName , Total = s.Sal + (s.Comm ?? 0)}); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(
            ...
            .Join(
                ...
                combined => true,  
                grade => true,     
                (combined, grade) => new { combined.emp, combined.dept, grade })
            .Where(triple => triple.emp.Sal >= triple.grade.Losal && 
                             triple.emp.Sal <= triple.grade.Hisal)
            .Select(triple => new { 
                triple.emp.EName, 
                DName = triple.dept.DName, 
                triple.grade.Grade 
            });
